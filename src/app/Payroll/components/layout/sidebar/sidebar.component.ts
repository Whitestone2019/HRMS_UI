  ...
  template: `
    <aside class="sidebar">
      <div class="sidebar-header">
        <img src="/assets/images/WHITESTONE.png" alt="" class="logo">
      </div>
      <nav class="sidebar-nav">
        <div class="nav-section">
          <div class="nav-group">
            <a routerLink="/payroll/overview" routerLinkActive="active" [routerLinkActiveOptions]="{ exact: true }" class="nav-item">
          ...
          <div class="nav-group">
            <div class="group-title nav-item collapsible" (click)="toggleSettings()">
              <i class="fas fa-cogs"></i>
              <span>Configuration</span>
              <i class="fas" [class.fa-chevron-down]="!settingsExpanded" [class.fa-chevron-up]="settingsExpanded" style="margin-left:auto;"></i>
            </div>
